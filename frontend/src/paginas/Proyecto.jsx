		...
		<>
			...
			{admin && (
				<button
					...
					type="button"
					className="flex items-center gap-2 mt-5 text-sm px-5 py-3 w-full md:w-auto rounded-lg uppercase font-bold bg-sky-600 hover:bg-sky-700 text-white text-center transition-colors justify-center"
				>
					<svg
						xmlns="http://www.w3.org/2000/svg"
						fill="none"
